...
|@dealer@|<>Нет|@String@|Название дилера. Не имеет смысла, если задано свойство @dealerId@. Информацию о диллере можно получить через сервис *"/service/salepoint":/service/salepoint*|
|@dealerId@|<>Нет|@String@|Идентификатор дилера. Информацию о диллере (включая идентификатор) можно получить через сервис *"/service/salepoint":/service/salepoint*|
