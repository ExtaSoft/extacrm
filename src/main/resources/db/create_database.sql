...
CREATE TABLE INSURANCE (ID VARCHAR(46) NOT NULL, A7_NUM VARCHAR(255), CREATED_AT DATETIME, CREATED_BY VARCHAR(20), `DATE` DATE, END_DATE DATE, MODIFIED_AT DATETIME, MODIFIED_BY VARCHAR(20), MOTOR_BRAND VARCHAR(255), MOTOR_MODEL VARCHAR(255), MOTOR_TYPE VARCHAR(255), PAYMENT_DATE DATE, POINT_OF_SALE VARCHAR(255), PREMIUM DECIMAL(38), REG_NUM VARCHAR(255), RISK_SUM DECIMAL(38), START_DATE DATE, VERSION INTEGER, CLIENT_ID VARCHAR(46), DEALER_ID VARCHAR(46), PRIMARY KEY (ID))
CREATE TABLE LEAD (ID VARCHAR(46) NOT NULL, COMMENT VARCHAR(255), CONTACT_EMAIL VARCHAR(255), CONTACT_NAME VARCHAR(255), CONTACT_PHONE VARCHAR(255), CREATED_AT DATETIME, CREATED_BY VARCHAR(20), MODIFIED_AT DATETIME, MODIFIED_BY VARCHAR(20), MOTOR_BRAND VARCHAR(255), MOTOR_MODEL VARCHAR(255), MOTOR_TYPE VARCHAR(255), MOTOR_PRICE DECIMAL(38), POINT_OF_SALE VARCHAR(255), REGION VARCHAR(255), STATUS VARCHAR(255), VERSION INTEGER, CLIENT_ID VARCHAR(46), VENDOR_ID VARCHAR(46), PRIMARY KEY (ID))
CREATE TABLE PAY_ACCOUNT (ID VARCHAR(46) NOT NULL, BANK_CODE VARCHAR(255), BANK_NAME VARCHAR(255), CREATED_AT DATETIME, CREATED_BY VARCHAR(20), LORO_ACCOUNT VARCHAR(255), MODIFIED_AT DATETIME, MODIFIED_BY VARCHAR(20), SETTLEMENT_ACCOUNT VARCHAR(255), VERSION INTEGER, CONTACT_ID VARCHAR(46), PRIMARY KEY (ID))
CREATE TABLE PERSON (ID VARCHAR(46) NOT NULL, BIRTHDAY DATE, JOB_DEPARTMENT VARCHAR(255), JOB_POSITION VARCHAR(255), PASS_ISSUE_DATE DATE, PASS_ISSUED_BY VARCHAR(255), PASS_ISSUED_BY_NUM VARCHAR(255), PASS_NUM VARCHAR(255), SEX VARCHAR(255), PRIMARY KEY (ID))
CREATE TABLE POLICY (ID VARCHAR(46) NOT NULL, BOOK_TIME DATETIME, CREATED_AT DATETIME, CREATED_BY VARCHAR(20), ISSUE_DATE DATETIME, MODIFIED_AT DATETIME, MODIFIED_BY VARCHAR(20), REG_NUM VARCHAR(255), VERSION INTEGER, PRIMARY KEY (ID))
CREATE TABLE USER_GROUP (ID VARCHAR(46) NOT NULL, CREATED_AT DATETIME, CREATED_BY VARCHAR(20), MODIFIED_AT DATETIME, MODIFIED_BY VARCHAR(20), NAME VARCHAR(255), VERSION INTEGER, PRIMARY KEY (ID))
CREATE TABLE USER_PROFILE (ID VARCHAR(46) NOT NULL, BLOCKED TINYINT(1) default 0, CHANGE_PASSWORD TINYINT(1) default 0, CREATED_AT DATETIME, CREATED_BY VARCHAR(20), LOGIN VARCHAR(255), MODIFIED_AT DATETIME, MODIFIED_BY VARCHAR(20), PASSWORD VARCHAR(255), PASSWORD_SALT VARCHAR(255), ROLE VARCHAR(255), VERSION INTEGER, CONTACT_ID VARCHAR(46), PRIMARY KEY (ID))
CREATE TABLE FORM_TRANSFER_NUMS (FormTransfer_ID VARCHAR(46), FORMNUMS VARCHAR(255))
...
ALTER TABLE FORM_TRANSFER_NUMS ADD CONSTRAINT FK_FORM_TRANSFER_NUMS_FormTransfer_ID FOREIGN KEY (FormTransfer_ID) REFERENCES FORM_TRANSFER (ID)
