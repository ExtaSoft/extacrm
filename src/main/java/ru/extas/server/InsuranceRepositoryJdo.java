...
public class InsuranceRepositoryJdo implements Serializable, InsuranceRepository {
	...
	public void fillRegistry() {
		...
		create(new Insurance("08905/213/00021/3", "СП-2013/00021", fmt.parseLocalDate("21.03.2013").toDate(), "Демидов Сергей Николаевич", fmt
		...
		create(new Insurance("08905/213/00022/3", "СП-2013/00022", fmt.parseLocalDate("21.03.2013").toDate(), "Савельев Денис Владимирович", fmt
		...
		create(new Insurance("08905/213/00023/3", "СП-2013/00023", fmt.parseLocalDate("28.03.2013").toDate(), "Аляутдинов Рафаэль Хамитович", fmt
		...
		create(new Insurance("08905/213/00024/3", "СП-2013/00024", fmt.parseLocalDate("28.03.2013").toDate(), "Коробейкин Роман Сергеевич", fmt
		...
		create(new Insurance("08905/213/00025/3", "СП-2013/00025", fmt.parseLocalDate("19.04.2013").toDate(), "Куприянов Кирилл Сергеевич", fmt
		...
		create(new Insurance("08905/213/00026/3", "СП-2013/00026", fmt.parseLocalDate("19.04.2013").toDate(), "Рогачев Кирилл Евгеньевич", fmt
		...
		create(new Insurance("08905/213/00027/3", "СП-2013/00027", fmt.parseLocalDate("08.04.2013").toDate(), "Вакула Леонид Александрович", fmt
		...
		create(new Insurance("08905/213/00028/3", "СП-2013/00028", fmt.parseLocalDate("19.04.2013").toDate(), "Арсенян Саргис Андраникович", fmt
	...
	/* (non-Javadoc)
	 * @see ru.extas.server.InsuranceRepository#update(ru.extas.model.Insurance)
	 */
	@Override
