...
public class SalesChartByBanks extends AbstractSalesChart {
    ...
    private void updateDataByBankStatus() {
        ...
        conf.removexAxes();
        conf.addxAxis(x);
        final ListSeries openedSeries = new ListSeries("На рассмотрении");
        final ListSeries closedSeries = new ListSeries("Одобренные");
        final ListSeries rejectedSeries = new ListSeries("Отклоненные");
