 ...
 * @version 2.0
 */
public abstract class LoanInSmthEditForm<T> extends ExtaEditForm<T> {
     ...
     * @param brandSupplier
     */
    public LoanInSmthEditForm(final String caption, final T targetObject, final SupplierSer<BigDecimal> priceSupplier,
...
/*    protected LoanInSmthEditForm(String caption, T t) {
        super(caption, t);
    }*/
}
