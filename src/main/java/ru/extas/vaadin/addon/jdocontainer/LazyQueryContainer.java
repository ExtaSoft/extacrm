...
public class LazyQueryContainer implements Indexed, Sortable, ItemSetChangeNotifier, PropertySetChangeNotifier,
     ...
     */
    private final List<ItemSetChangeListener> itemSetChangeListeners = new ArrayList<>();
    /**
     * List of registered PropertySetChangeListeners.
     */
    private final List<PropertySetChangeListener> propertySetChangeListeners = new ArrayList<>();
     ...
     */
    LazyQueryContainer(final QueryDefinition queryDefinition, final QueryFactory queryFactory) {
    ...
    public final Object nextItemId(final Object itemId) {
        final List<?> itemIdList = queryView.getItemIdList();
    ...
    public Collection<Filter> getContainerFilters() {
        return getQueryView().getQueryDefinition().getFilters();
    }
