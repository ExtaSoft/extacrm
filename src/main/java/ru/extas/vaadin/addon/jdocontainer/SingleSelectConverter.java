...
public class SingleSelectConverter<T extends AbstractExtaObject> implements Converter<Object, T> {
	...
	public T convertToModel(final Object value, final Locale locale)
	...
	public Object convertToPresentation(final T value, final Locale locale)
			throws com.vaadin.data.util.converter.Converter.ConversionException {
		if (value != null)
			return 0;
	 ...
	 */
	@Override
	public Object convertToPresentation(final T value, final Class<? extends Object> targetType, final Locale locale)
			throws com.vaadin.data.util.converter.Converter.ConversionException {
