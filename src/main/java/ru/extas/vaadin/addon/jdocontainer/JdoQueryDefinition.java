...
public class JdoQueryDefinition<E> extends LazyQueryDefinition {
	...
	LinkedHashMap<String, VaadinPropertyDescriptor<E>> getPropertyDescriptors(
		...
		final LinkedHashMap<String, VaadinPropertyDescriptor<E>> pdMap = new LinkedHashMap<String, VaadinPropertyDescriptor<E>>();
		...
		try {
			...
			for (final PropertyDescriptor pd : propertyDescriptors) {
				...
				if ((getMethod != null)
					...
					final VaadinPropertyDescriptor<E> vaadinPropertyDescriptor = new MethodPropertyDescriptor<E>(
