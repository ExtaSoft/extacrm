 ...
 * <p/>
 * LazyQueryView implements mainly batch loading, caching and debug functionalities. When data is sorted old query is
 * discarded and new constructed with QueryFactory and new sort state.
 *
...
public final class LazyQueryView implements QueryView, ValueChangeListener {
     ...
     */
    private static final String DEBUG_PROPERTY_ID_QUERY_INDEX = "DEBUG_PROPERTY_ID_QUERY_COUT";
    /**
     * Batch index debug property ID.
     */
    private static final String DEBUG_PROPERTY_ID_BATCH_INDEX = "DEBUG_PROPERTY_ID_BATCH_INDEX";
    /**
     * Batch query time debug property ID.
     */
    private static final String DEBUG_PROPERTY_ID_BATCH_QUERY_TIME = "DEBUG_PROPERTY_ID_BATCH_QUERY_TIME";
    /**
     * Item status property ID.
     */
    private static final String PROPERTY_ID_ITEM_STATUS = "PROPERTY_ID_ITEM_STATUS";
    /**
     ...
     */
    private final LinkedList<Integer> itemCacheAccessLog = new LinkedList<>();
    /**
     ...
     */
    private final List<Item> modifiedItems = new ArrayList<>();
    /**
    ...
    public Item getItem(final int index) {
        ...
        if (!itemCache.containsKey(index - addedItemCount)) {
            ...
            itemCacheAccessLog.addLast(index);
        }
    ...
    public void commit() {
        ...
        final List<Item> addedItemReversed = new ArrayList<>(addedItems);
    ...
    public List<?> getItemIdList() {
        if (itemIdList == null) {
            final Object idPropertyId = queryDefinition.getIdPropertyId();
            if (idPropertyId != null) {
                if (idPropertyId.equals("this")) itemIdList = new LazyBeanList<Object>(this);
                else itemIdList = new LazyIdList<Object>(this, idPropertyId);
            } else {
