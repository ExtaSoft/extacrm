...
public final class LazyQueryView implements QueryView, ValueChangeListener {
	 ...
	 *            The sort state of the properties participating in
	...
	public Item getItem(final int index) {
		if (index < 0 || index >= size()) { throw new IndexOutOfBoundsException("Container size: " + size()
	...
	public void valueChange(final ValueChangeEvent event) {
		...
		if (property == item.getItemProperty(PROPERTY_ID_ITEM_STATUS)) { return; }
		if (item.getItemProperty(PROPERTY_ID_ITEM_STATUS) != null
