...
public class UserRealm extends AuthorizingRealm {
	...
	@Inject
	public UserRealm(MySecurityManagerService mySecurityManagerService) {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
		...
		return new SimpleAccount(principal.getUsername(), principal.getPassword(), getName(), principal.getRoles(), new HashSet());
	}
}