...
public class UserRealm extends AuthorizingRealm {
	...
	private void grantPermissions(final UserProfile userProfile, final SimpleAuthorizationInfo authorizationInfo) {
		grantDefaultPermissions(userProfile.getRole(), authorizationInfo);
	}
	 ...
	 */
	private void grantDefaultPermissions(final UserRole role, final SimpleAuthorizationInfo authorizationInfo) {
		final List<Permission> permissions;
		switch (role) {
			case USER:
				permissions = DefaultRolePermissoin.createUserPermissions();
				break;
			case MANAGER:
				permissions = DefaultRolePermissoin.createManagerPermissions();
				break;
			case DEALER:
