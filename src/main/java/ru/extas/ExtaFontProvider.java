...
class ExtaFontProvider implements IFontProvider {
    ...
    boolean isBold(int style) {
        return style != Font.UNDEFINED && (style & Font.BOLD) == Font.BOLD;
    }
    ...
    boolean isItalic(int style) {
        return style != Font.UNDEFINED && (style & Font.ITALIC) == Font.ITALIC;
    }
    ...
    public boolean isUnderlined(int style) {
        return style != Font.UNDEFINED && (style & Font.UNDERLINE) == Font.UNDERLINE;
    }
    ...
    public boolean isStrikethru(int style) {
        return style != Font.UNDEFINED && (style & Font.STRIKETHRU) == Font.STRIKETHRU;
    }
    ...
    String resolveFamilyName(String familyName, int style) {
